...
<body>
    <form action="work_insert.php" method="post">
        ...
        <div class="container mt-4">
            ...
            <div class="row">
                ...
                <div class="col-9">
                    ...
                    <div class="mb-3">
                        <label for="textarea" class="form-label">Work status</label>
                        <textarea class="form-control w-50" rows="5" name="status"><?php echo isset($_SESSION['status']) ? $_SESSION['status'] : '' ?></textarea>
                    </div>
                    <div>
